...
m = size(A,1); % Number of constraints (number of slack/surplus variables)
n = size(A,2); % Number of original decision variables
...
% Determining a starting feasible initial basic solution (solving the auxiliary problem)
